...
let signin = () => {
  ...
  firebase
    ...
    .then(() => {
      ...
      errH.innerHTML = stdName.value + ", Please Provide Your Key"; // display this line with user's name
    })
    .catch(function (error) {
      // Handle Errors here.
      var errorCode = error.code;
...
function showResult(percentage, ca) {
  if (percentage == 100) {
    RColor = "teal";
    resultFb.innerHTML =
      "Wohoo..  Great,  " + localStorage.getItem("name") + " You are pass!";
    correctAns.innerHTML = "Correct Answers: " + ca;
  } else if (percentage >= 80) {
    RColor = "green";
    resultFb.innerHTML =
      "Congrats! " + localStorage.getItem("name") + "  You are pass.";
    correctAns.innerHTML = "Correct Answers: " + ca;
  } else if (percentage >= 65) {
    RColor = "blue";
    resultFb.innerHTML =
      "Good Effort, " + localStorage.getItem("name") + "  You are pass.";
    correctAns.innerHTML = "Correct Answers: " + ca;
  } else if (percentage >= 50) {
    RColor = "orange";
    resultFb.innerHTML = localStorage.getItem("name") + "  You are passed!";
    correctAns.innerHTML = "Correct Answers: " + ca;
  } else {
    RColor = "red";
    resultFb.innerHTML =
      ...
      "  Your Are Failed... <br> Better Luck Next Time";
    correctAns.innerHTML = "Correct Answers: " + ca;
  }
...
function sentToFirebase() {
  let studentScore = {
    ...
    score: localStorage.getItem("ca"),
  };
  var db = firebase
    .database()
    .ref("/score")
    .push(studentScore, function () {
      alert("Your Score has been noted.");
    });
